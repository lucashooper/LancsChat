...
const POOL = [
  ...
  { displayName: 'county_college', avatarColor: '#96CEB4' },
  { displayName: 'midnight_essay', avatarColor: '#BB8FCE' },
  { displayName: 'bowland_b', avatarColor: '#45B7D1' },
  { displayName: 'lancs_fresher', avatarColor: '#FFEAA7' },
  { displayName: 'library_rat', avatarColor: '#85C1E9' },
  { displayName: 'gradgrind', avatarColor: '#F0B27A' },
  { displayName: 'emma_k92', avatarColor: '#DDA0DD' },
  { displayName: 'alexandra92', avatarColor: '#82E0AA' },
  { displayName: 'williamson_w', avatarColor: '#F1948A' },
  { displayName: 'grizedale_g', avatarColor: '#98D8C8' },
  { displayName: 'pendle_p', avatarColor: '#AED6F1' },
  { displayName: 'lonsdale_l', avatarColor: '#F7DC6F' },
